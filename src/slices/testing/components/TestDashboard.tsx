        ...
        <div className="border-b border-gray-200">
          <nav className="-mb-px flex space-x-8 px-6" aria-label="Test types">
            <button
              ...
              className={`py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'functional'
            ...
            <button
              ...
              className={`py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'accessibility'
                  ? 'border-blue-500 text-blue-600'
                  : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                } transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2`}
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-sm space-y-1">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className={`font-medium ${testResults.totalFailed === 0 ? 'text-green-600' : 'text-red-600'
                        }`}>
